...
struct SettingsMenuView {
  ...
  static constexpr const char* const ITEMS[] = {"Notes", "Home Art", "Wireless Transfer", "WiFi Setup", "Reader", "Device", "Bluetooth", "Cleanup", "System Info"};
  static constexpr int ITEM_COUNT = 9;
#elif FEATURE_PLUGINS
  static constexpr const char* const ITEMS[] = {"Notes", "Home Art", "Wireless Transfer", "WiFi Setup", "Reader", "Device", "Cleanup", "System Info"};
